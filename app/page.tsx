...
const chinaStops: TravelStop[] = [
  { code:"XJ", country:"新疆", left:"24%", top:"49%", cities:["阿勒泰"], note:"雪山、草原与很长的公路，让目的地之外的过程也成为旅行。", photos:[[37,"阿勒泰"],[38,"阿勒泰"],[39,"阿勒泰"],[40,"阿勒泰"]] },
  { code:"XZ", country:"西藏", left:"31%", top:"66%", cities:["拉萨", "珠峰大本营", "羊卓雍措"], note:"在高原上，距离和时间都拥有了与城市完全不同的意义。", photos:[[73,"拉萨"],[74,"拉萨"],[75,"珠峰大本营"],[76,"羊卓雍措"]] },
  { code:"QH", country:"青海", left:"42%", top:"54%", cities:["青海"], note:"湖泊、荒原和公路构成了一种宽阔、安静的自由。", photos:[[78,"青海"],[79,"青海"]] },
  { code:"GS", country:"甘肃", left:"50%", top:"51%", cities:["张掖", "敦煌 · 莫高窟"], note:"自然地貌与千年文化在这里彼此照亮。", photos:[[61,"张掖"],[62,"张掖"],[63,"莫高窟"]] },
  { code:"JL", country:"吉林", left:"80%", top:"35%", cities:["吉林", "延边"], note:"北方的冬天和边境城市，让熟悉的国内旅行拥有另一种气质。", photos:[[4,"吉林"],[5,"延边"]] },
  { code:"ZJ", country:"浙江", left:"75%", top:"68%", cities:["温岭"], note:"从这里出发，也一次次回到这里。", photos:[[55,"温岭"]] },
  { code:"SN", country:"陕西", left:"58%", top:"56%", cities:["西安"], note:"历史不是遥远的背景，而是仍然参与城市生活的一部分。", photos:[[72,"西安"],[85,"西安美食"],[86,"西安美食"]] },
  { code:"HN", country:"湖南", left:"63%", top:"70%", cities:["长沙"], note:"鲜活、热烈、有自己的城市节奏。", photos:[[77,"长沙"],[87,"长沙"],[88,"湖南美食"]] },
  { code:"HI", country:"海南", left:"64%", top:"86%", cities:["三亚"], note:"海风、热带阳光和漫长夏天。", photos:[[1,"三亚"],[56,"三亚"]] },
  { code:"HK", country:"香港", left:"72%", top:"79%", cities:["香港"], note:"密度、速度与电影感叠在同一座城市。", photos:[[80,"香港"]] },
  { code:"MO", country:"澳门", left:"69%", top:"80%", cities:["澳门"], note:"在很小的尺度里，旧建筑与旅行记忆交错出现。", photos:[[60,"澳门"]] },
];
